...
//		}
		...
		protected void SetupFromXmlResource(string resourceName)
		{
            ...
            Stream resourceStream = caller.GetManifestResourceStream(resourceName);
            if (resourceStream == null)
            {
                resourceName = "Resources." + resourceName;
                resourceStream = caller.GetManifestResourceStream(resourceName);
            }   

            SetupFromXmlStream(resourceStream);
		}
