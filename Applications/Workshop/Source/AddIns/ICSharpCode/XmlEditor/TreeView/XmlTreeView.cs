...
namespace ICSharpCode.XmlEditor
{
	...
	public class XmlTreeView : AbstractSecondaryViewContent, IClipboardHandler
	{
        ...
        private XmlTreeViewContainerControl treeViewContainer;
		...
		protected override void LoadFromPrimary()
		{
			...
			XmlCompletionDataProvider completionDataProvider = 
                new XmlCompletionDataProvider(xmlEditor.SchemaCompletionDataItems, 
        ...
        private void TreeViewContainerDirtyChanged(object source, EventArgs e)
		{
