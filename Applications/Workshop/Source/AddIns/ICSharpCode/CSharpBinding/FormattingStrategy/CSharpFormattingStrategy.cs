...
namespace CSharpBinding.FormattingStrategy
{
	...
	/// you type.
	/// </summary>
    public sealed class CSharpFormattingStrategy : DefaultFormattingStrategy
	{
		...
		bool NeedEndregion(ITextDocument document)
		{
			int regions = 0;
			int endregions = 0;
		...
		static int ScanLineStart(ITextDocument document, int offset)
		{
		...
		/// </summary>
		static int GetStartType(ITextDocument document, int linestart, int offset)
		{
			bool inString = false;
			bool inChar = false;
			bool verbatim = false;
		...
		public override int SearchBracketBackward(ITextDocument document, int offset, char openBracket, char closingBracket)
		{
		...
		public override int SearchBracketForward(ITextDocument document, int offset, char openBracket, char closingBracket)
		{
			bool inString = false;
			bool inChar   = false;
			bool verbatim = false;
