...
{
    public sealed class EventHandlerCompletitionDataProvider : AbstractCompletionDataProvider
	{
		string expression;
        ...
        private sealed class DelegateCompletionData : CompletionData
		{
			int cursorOffset;
        ...
        private sealed class NewEventHandlerCompletionData : CompletionData
		{
