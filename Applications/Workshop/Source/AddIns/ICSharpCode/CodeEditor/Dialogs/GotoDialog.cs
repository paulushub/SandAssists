...
namespace ICSharpCode.SharpDevelop.Gui
{
	public partial class GotoDialog: Form
	{
        ...
        public GotoDialog()
		{
            ...
            //SetupFromXmlStream(this.GetType().Assembly.GetManifestResourceStream("ICSharpCode.SharpDevelop.Resources.GotoDialog.xfrm"));
        ...
        IList<ICompletionData> ctrlSpaceCompletionData;
        ...
        IList<ICompletionData> Resolve(string expression)
        {
            TextEditorControl editor = GetEditor();
            if (editor != null)
            {
        ...
        void TextBoxTextChanged(object sender, EventArgs e)
        {
            ...
            else if (dotPos > 0)
            {
                ...
                {
                    if (c.Name.Equals(expression, StringComparison.OrdinalIgnoreCase))
                    {
        ...
        void ShowCompletionData(IList<ICompletionData> dataList, string text)
        {
