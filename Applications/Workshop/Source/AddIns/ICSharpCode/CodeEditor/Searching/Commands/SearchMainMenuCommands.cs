...
namespace ICSharpCode.TextEditor.Searching
{
	public class Find : AbstractMenuCommand
	{
		public static void SetSearchPattern()
		{
			...
			if (textArea != null) 
            {
                ...
                {
					SearchOptions.FindPattern = selectedText;
				}
			}
		}
		...
		{
			SetSearchPattern();
            SearchDialog.ShowSingleInstance(SearchAndReplaceMode.Search);
		}
	...
	public class FindNext : AbstractMenuCommand
	{
		public override void Run()
		{
            ...
            string cachedFind = SearchOptions.FindPattern;

            DocumentIteratorType iterator = SearchOptions.DocumentIteratorType;
            if (iterator != DocumentIteratorType.CurrentDocument)
            {
                SearchOptions.DocumentIteratorType = DocumentIteratorType.CurrentDocument;
            }
            if (cachedFind != null && cachedFind.Length > 0) 
            {
    ...
    public class FindPrevious : AbstractMenuCommand
	{
		public override void Run()
		{
            TextEditorControl textArea = SearchReplaceUtilities.GetActiveTextEditor();
	...
	public class FindNextSelected : AbstractMenuCommand
	{
		public override void Run()
		{
			...
			if (textToFind != null && textToFind.Length > 0) {
				SearchOptions.FindPattern = textToFind;
                DocumentIteratorType iterator = SearchOptions.DocumentIteratorType;
                if (iterator != DocumentIteratorType.CurrentDocument)
                {
					SearchOptions.DocumentIteratorType = DocumentIteratorType.CurrentDocument;
	...
	public class Replace : AbstractMenuCommand
	{
		public override void Run()
		{
            ...
            SearchDialog.ShowSingleInstance(SearchAndReplaceMode.Replace);
		}
    }
    ...
    public class FindInFiles : AbstractMenuCommand
	{
		...
		public override void Run()
		{
            ...
            {
                SearchOptions.DocumentIteratorType = DocumentIteratorType.WholeSolution;
            }
            SetSearchPattern();
            SearchDialog.ShowSingleInstance(SearchAndReplaceMode.Search);
		}
