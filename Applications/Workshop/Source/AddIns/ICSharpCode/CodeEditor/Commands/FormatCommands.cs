...
{
    public sealed class RemoveLeadingWS : AbstractEditActionMenuCommand
	{
    ...
    public sealed class RemoveTrailingWS : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
    ...
    public sealed class ToUpperCase : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
    ...
    public sealed class ToLowerCase : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
    ...
    public sealed class InvertCaseAction : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
    ...
    public sealed class CapitalizeAction : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
    ...
    public sealed class ConvertTabsToSpaces : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
    ...
    public sealed class ConvertSpacesToTabs : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
    ...
    public sealed class ConvertLeadingTabsToSpaces : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
    ...
    public sealed class ConvertLeadingSpacesToTabs : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
	...
	/// <summary>
	/// This is a sample edit action plugin, it indents the selected area.
	/// </summary>
    public sealed class FormatSelection : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
                return new ICSharpCode.TextEditor.Actions.FormatSelection();
			}
		}
	}
	...
	/// This is a sample edit action plugin, it indents the selected area.
	/// </summary>
    public sealed class IndentLine : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
                return new ICSharpCode.TextEditor.Actions.Tab();
			}
		}
	}
	...
	/// This is a sample edit action plugin, it indents the selected area.
	/// </summary>
    public sealed class OutlineLine : AbstractEditActionMenuCommand
	{
		public override IEditAction EditAction {
			get {
                return new ICSharpCode.TextEditor.Actions.ShiftTab();
			}
		}
	}
	...
	/// This is a sample edit action plugin, it indents the selected area.
	/// </summary>
    public sealed class SortSelection : AbstractMenuCommand
	{
		...
		public void SortLines(ITextDocument document, int startLine, int endLine)
		{
