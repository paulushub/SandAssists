	...
	public static class MenuService
	{
		...
		static object CreateMenuItemFromDescriptor(MenuItemDescriptor descriptor)
		{
			...
			switch (type) {
                ...
                case "ComboBox":
                    return new MenuComboBox(codon, descriptor.Caller);
				case "Item":
				case "Command":
		...
		public static ContextMenuStrip CreateContextMenu(object owner, string addInTreePath)
		{
			...
			try 
            {
				List<MenuItemDescriptor> descriptors = 
                    AddInTree.BuildItems<MenuItemDescriptor>(addInTreePath, owner, true);
            ...
            catch (TreePathNotFoundException) 
            {
				MessageService.ShowError(
                    "Warning tree path '" + addInTreePath +"' not found.");
				return null;
			}
		}
