	...
	public class NRefactoryResolver : IResolver
	{
		                             ...
		                             string fileContent)
		{
			...
			if (language == NR.SupportedLanguage.VBNet) {
				...
				} else if (expression.Equals("global", StringComparison.OrdinalIgnoreCase)) {
		...
		{                          
			if (language == NR.SupportedLanguage.VBNet) {
				...
				if (expression.Equals("mybase", StringComparison.OrdinalIgnoreCase)) {
					return new BaseReferenceExpression();
				} else if (expression.Equals("myclass", StringComparison.OrdinalIgnoreCase)) {
