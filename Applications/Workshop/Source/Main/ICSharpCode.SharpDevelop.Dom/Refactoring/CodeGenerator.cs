...
namespace ICSharpCode.SharpDevelop.Dom.Refactoring
{
	...
	public abstract class CodeGenerator
	{
		...
		public virtual void InsertCodeAfter(IMember member, IRefactorDocument document, params AbstractNode[] nodes)
		{
		...
		public virtual void InsertCodeAtEnd(DomRegion region, IRefactorDocument document, params AbstractNode[] nodes)
		{
			InsertCodeAfter(region.EndLine - 1, document,
			                GetIndentation(document, region.BeginLine) + options.IndentString, nodes);
		}
		
		public virtual void InsertCodeInClass(IClass c, IRefactorDocument document, int targetLine, params AbstractNode[] nodes)
		{
			InsertCodeAfter(targetLine, document,
			                GetIndentation(document, c.Region.BeginLine) + options.IndentString, false, nodes);
		}
		
		protected string GetIndentation(IRefactorDocument document, int line)
		{
		...
		/// </summary>
		protected void InsertCodeAfter(int insertLine, IRefactorDocument document, string indentation, params AbstractNode[] nodes)
		{
		...
		/// after the line <paramref name="insertLine"/>.
		/// </summary>
		protected void InsertCodeAfter(int insertLine, IRefactorDocument document, string indentation, bool startWithEmptyLine, params AbstractNode[] nodes)
		{
			IRefactorDocumentLine lineSegment = document.GetLine(insertLine + 1);
		...
		public virtual void CreateChangedEvent(IProperty property, IRefactorDocument document)
		{
		...
		public virtual MethodDeclaration CreateOnEventMethod(IEvent e)
		{
			...
			if (e.ReturnType != null) {
				...
				if (invoke != null) {
					...
					if (parameters.Count > 0 && string.Equals(parameters[0].ParameterName, "sender", StringComparison.OrdinalIgnoreCase)) {
						sender = true;
		...
		public virtual void ImplementInterface(IReturnType interf, IRefactorDocument document, bool explicitImpl, IClass targetClass)
		{
		...
		public virtual void ReplaceUsings(IRefactorDocument document, IList<IUsing> oldUsings, IList<IUsing> newUsings)
		{
