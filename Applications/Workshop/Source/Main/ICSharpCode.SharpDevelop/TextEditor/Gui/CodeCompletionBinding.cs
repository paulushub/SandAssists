...
namespace ICSharpCode.SharpDevelop.TextEditor.Gui
{
	...
	public interface ICodeCompletionBinding
	{
		...
		bool CtrlSpace(CodeEditorControl editor);
	}
	...
	/// </attribute>
	/// <usage>Only in /AddIns/TextEditor/CodeCompletion</usage>
	/// <returns>
	...
	public sealed class LazyCodeCompletionBinding : ICodeCompletionBinding
	{
		...
		public bool HandleKeyPress(CodeEditorControl editor, char ch)
		{
		...
		public bool CtrlSpace(CodeEditorControl editor)
		{
			string ext = Path.GetExtension(editor.FileName);
			foreach (string extension in extensions) {
				if (ext.Equals(extension, StringComparison.OrdinalIgnoreCase)) {
	...
	public class CodeCompletionBinding : ICodeCompletionBinding
	{
		...
		public virtual bool CtrlSpace(CodeEditorControl editor)
		{
