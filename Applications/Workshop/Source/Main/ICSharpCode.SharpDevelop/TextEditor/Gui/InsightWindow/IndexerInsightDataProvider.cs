...
namespace ICSharpCode.SharpDevelop.TextEditor.Gui
{
	public class IndexerInsightDataProvider : MethodInsightDataProvider
	{
		...
		protected override void SetupDataProvider(string fileName, ITextDocument document, ExpressionResult expressionResult, int caretLineNumber, int caretColumn)
		{
