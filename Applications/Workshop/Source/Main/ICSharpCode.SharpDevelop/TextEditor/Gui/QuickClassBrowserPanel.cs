...
namespace ICSharpCode.SharpDevelop.TextEditor.Gui
{
	public class QuickClassBrowserPanel : UserControl
	{
		...
		{
			InitializeComponent();
            this.classComboBox.MaxDropDownItems = 5;
			this.membersComboBox.MaxDropDownItems = 30;
...
//				classComboBox.SelectedIndex = -1;
		...
		void InitializeComponent() {
            ...
            this.membersComboBox.DropDownHeight = 600;
            ...
            this.membersComboBox.Size = new System.Drawing.Size(371, 21);
            ...
            this.classComboBox.DropDownHeight = 300;
		...
		{
			//Size comboBoxSize = new Size((Width - 4 * 3) / 2, 21);
			Size comboBoxSize = new Size((Width - 4) / 2, 21);
			classComboBox.Size = comboBoxSize;
            classComboBox.Location = new Point(0, classComboBox.Bounds.Top);
			membersComboBox.Location = new Point(classComboBox.Bounds.Right + 4, classComboBox.Bounds.Top);
			membersComboBox.Size = comboBoxSize;
		}
		
		void MeasureComboBoxItem(object sender, MeasureItemEventArgs e)
		{
			ComboBox comboBox = (ComboBox)sender;
			if (e.Index >= 0) {
				ComboBoxItem item = (ComboBoxItem)comboBox.Items[e.Index];
