...
{
	/// <summary>
    /// Description of CodeEditorPad.
	/// </summary>
	public abstract class CodeEditorPad : AbstractPadContent, IEditable, 
        IUndoHandler, IPositionable, ITextEditorControlProvider, 
        IPrintable, IToolsHost, IClipboardHandler
	{
        ...
        public virtual ITextDocument GetDocumentForFile(OpenedFile file)
        {
            return null;
        }
