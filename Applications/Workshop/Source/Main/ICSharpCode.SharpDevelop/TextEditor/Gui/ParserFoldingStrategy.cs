...
namespace ICSharpCode.SharpDevelop.TextEditor.Gui
{
	...
	{
		void AddClassMembers(IClass c, List<FoldMarker> foldMarkers, ITextDocument document)
		{
		...
		/// </remarks>
		public List<FoldMarker> GenerateFoldMarkers(ITextDocument document, string fileName, object parseInfo)
		{
		...
		List<FoldMarker> GetFoldMarkers(ITextDocument document, ICompilationUnit cu)
		{
