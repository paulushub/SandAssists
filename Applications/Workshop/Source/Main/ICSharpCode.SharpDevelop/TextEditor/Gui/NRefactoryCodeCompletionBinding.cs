...
namespace ICSharpCode.SharpDevelop.TextEditor.Gui
{
	...
	/// </summary>
	public abstract class NRefactoryCodeCompletionBinding : CodeCompletionBinding
	{
		...
		protected bool ProvideContextCompletion(CodeEditorControl editor, IReturnType expected, char charTyped)
		{
			...
			if (c.ClassType == ClassType.Enum) {
                ...
                IList<ICompletionData> completionData = cache.CompletionData;
                completionData = CompletionDataComparer.Sort(completionData);
