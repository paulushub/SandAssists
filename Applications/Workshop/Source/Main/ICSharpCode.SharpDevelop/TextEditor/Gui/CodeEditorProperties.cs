...
{
	public sealed class CodeEditorProperties : ITextEditorProperties
	{
		static CodeEditorProperties textEditorProperties;
		Properties properties;
		FontContainer fontContainer;
		
		public static CodeEditorProperties Instance {
			get {
				if (textEditorProperties == null) {
					textEditorProperties = new CodeEditorProperties();
				}
				return textEditorProperties;
			}
		}
		
		private CodeEditorProperties()
		{
