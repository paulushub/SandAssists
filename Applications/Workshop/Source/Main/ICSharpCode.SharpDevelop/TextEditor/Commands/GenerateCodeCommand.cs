...
using ICSharpCode.SharpDevelop.CodeGenerators;

namespace ICSharpCode.SharpDevelop.TextEditor.Commands
{
	public sealed class GenerateCodeAction : AbstractMenuCommand
	{
		public override void Run()
		{
			...
			if (currentClass != null) {
                var generators = AddInTree.BuildItems<CodeGeneratorBase>("/SharpDevelop/Editing/CodeGenerators", this, true);
		...
		/// <summary>
		/// Returns the class in which the caret currently is, returns null
		/// if the caret is outside the class boundaries.
		/// </summary>
