...
{
    public class ClassBrowserNavigateBackward : AbstractButtonCommand
	{
    ...
    public class ClassBrowserNavigateForward : AbstractButtonCommand
	{
		public override bool IsEnabled {
			get {
    ...
    public class ClassBrowserCommitSearch : AbstractButtonCommand
    {
		public override void Run()
		{
			ClassBrowserPad.Instance.StartSearch();
    ...
    public class ClassBrowserCancelSearch : AbstractButtonCommand
	{
		public override bool IsEnabled {
			get {
