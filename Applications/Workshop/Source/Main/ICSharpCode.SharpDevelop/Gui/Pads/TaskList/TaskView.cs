...
//			taskToolTip.ShowAlways   = false;
		...
		public void AddTask(Task task)
		{
			...
			try {
                ...
                {
                    path = FileUtility.GetRelativePath(
                        Project.ProjectService.OpenSolution.Directory, path);
                }
            }
            catch (Exception) { }
		...
		/// </summary>
		private class TaskViewSorter : IComparer<ListViewItem>,
            System.Collections.IComparer
		{
			...
			/// of item <paramref name="a"/> relative to item
			/// <paramref name="b"/>.
