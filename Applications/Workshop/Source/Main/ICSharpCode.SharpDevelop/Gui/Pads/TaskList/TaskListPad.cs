	...
	public class TaskListPad : AbstractPadContent, IClipboardHandler
	{
		...
		public TaskListPad()
		{
			...
			if (WorkbenchSingleton.Workbench.ActiveViewContent != null) {
				...
				if (WorkbenchSingleton.Workbench.ActiveViewContent.Control is TextEditorControl) {
                    TextEditorControl ctrl = WorkbenchSingleton.Workbench.ActiveViewContent.Control as TextEditorControl;
