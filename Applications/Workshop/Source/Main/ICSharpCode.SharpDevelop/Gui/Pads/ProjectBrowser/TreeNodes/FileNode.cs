...
{
	public class FileNode : BaseNode, IOwnerState
	{
		...
		void SetIcon()
		{
			switch (fileNodeStatus) {
				...
				case FileNodeStatus.InProject:
                    ...
                    {
                        string fileImage = IconService.GetImageForFile(this.FileName);
                        if (String.Equals(fileImage, "Icons.16x16.MiscFiles", 
                            StringComparison.CurrentCultureIgnoreCase))
                        {
                            fileImage = this.FileName;
                        }
                        SetIcon(fileImage);
                    }
					break;
		...
		public virtual string RelativePath {
			get {
                if (this.Parent is DirectoryNode)
                {
		...
		public FileNode(string fileName, FileNodeStatus fileNodeStatus)
		{
            ...
            this.ContextmenuAddinTreePath = "/SharpDevelop/Pads/ProjectBrowser/ContextMenu/FileNode";
