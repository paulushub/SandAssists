	...
	public class WebReferenceNodeBuilder
	{
		...
		public static TreeNode AddWebReferencesFolderNode(ProjectNode projectNode, WebReference webReference)
		{
			if (webReference.WebReferencesProjectItem != null) {
				WebReferenceFolderNode webReferencesFolderNode = new WebReferenceFolderNode(webReference.WebReferencesProjectItem);
		...
		public static TreeNode AddWebReference(WebReferenceFolderNode webReferencesFolderNode, WebReference webReference)
		{
