...
namespace ICSharpCode.TextEditor.Searching
{
	...
	public enum SearchResultPanelViewMode
	{
		Flat,
		PerFile,
		//Structural // TODO: ICSharpCode.TextEditor.Searching - develop Structural view
	}
	...
	public class SearchResultPanel : AbstractPadContent, IOwnerState
	{
		...
		public SearchResultPanelViewMode ViewMode {
			get {
				return PropertyService.Get("ICSharpCode.TextEditor.Searching.SearchResultPanelViewMode", SearchResultPanelViewMode.Flat);
			}
			set {
				PropertyService.Set("ICSharpCode.TextEditor.Searching.SearchResultPanelViewMode", value);
		...
		public SearchResultPanel()
		{
			...
			toolStrip = ToolbarService.CreateToolStrip(this, 
                "/SharpDevelop/Pads/SearchResultPanel/ToolBar/Standard");
