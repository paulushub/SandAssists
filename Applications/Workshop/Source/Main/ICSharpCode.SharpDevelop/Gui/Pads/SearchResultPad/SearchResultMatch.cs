...
namespace ICSharpCode.TextEditor.Searching
{
	...
	{
		SearchDocumentInfo providedDocumentInformation;
		int    offset;
		int    length;
		...
		public SearchDocumentInfo SearchDocumentInfo {
			set {
		...
		public virtual TextLocation GetStartPosition(ITextDocument document)
		{
			return document.OffsetToPosition(Math.Min(Offset, document.TextLength));
		}
		
		public virtual TextLocation GetEndPosition(ITextDocument document)
		{
	...
	public class SimpleSearchResultMatch : SearchResultMatch
	{
		...
		public override TextLocation GetStartPosition(ITextDocument doc)
		{
			return position;
		}
		
		public override TextLocation GetEndPosition(ITextDocument doc)
		{
			return position;
		}
