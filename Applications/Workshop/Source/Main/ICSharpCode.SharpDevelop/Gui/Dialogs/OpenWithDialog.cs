...
namespace ICSharpCode.SharpDevelop.Gui
{
	...
	public sealed partial class OpenWithDialog : Form
	{
		...
		public OpenWithDialog(IList<DisplayBindingDescriptor> displayBindings, int defaultBindingIndex, string fileName)
		{
            ...
            this.Text = StringParser.Parse(this.Text) + " - " + Path.GetFileName(fileName);
