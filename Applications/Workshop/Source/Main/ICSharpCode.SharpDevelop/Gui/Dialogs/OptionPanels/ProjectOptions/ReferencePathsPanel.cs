...
{
    public partial class ReferencePathsPanel : ProjectDialogPanel
    {
        public ReferencePathsPanel()
        {
            InitializeComponent();
        ...
        private sealed class SemicolonSeparatedStringListBinding : ConfigurationBinding
        {
