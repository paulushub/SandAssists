...
{
    public partial class SolutionConfigurationEditor : System.Windows.Forms.Form
	{
		Solution solution;
		...
		public SolutionConfigurationEditor()
		{
            ...
            foreach (Control ctl in this.Controls.GetRecursive())
            {
                ...
                DataGridView listView = ctl as DataGridView;
                if (listView != null)
                {
                    foreach (DataGridViewColumn header in listView.Columns)
                    {
                        header.HeaderText = StringParser.Parse(header.HeaderText);
                    }
                }
            }
