...
namespace ICSharpCode.SharpDevelop.Gui
{
	public class SharpDevelopSideBar : SideBarControl, IOwnerState
	{
		...
		public SharpDevelopSideBar()
		{
			...
			this.MouseUp            += new MouseEventHandler(SetContextMenu);
			this.TabContent.MouseUp += new MouseEventHandler(SetItemContextMenu);
		}
		...
		void SetItemContextMenu(object sender, MouseEventArgs e)
		{
			...
			if (e.Button == MouseButtons.Right) {
				...
				MenuService.ShowContextMenu(this, sideTabContextMenuPath, this.TabContent, e.X, e.Y);
			}
		}
