...
namespace ICSharpCode.SharpDevelop
{
	...
	/// &lt;Condition name="WindowOpen" openwindow="ICSharpCode.SharpDevelop.TextEditor.Gui.ITextEditorControlProvider"&gt;
	/// </example>
	/// <example title="Test if any window is open">
	/// &lt;Condition name="WindowOpen" openwindow="*"&gt;
	/// </example>
    public sealed class WindowOpenConditionEvaluator : IConditionEvaluator
	{
