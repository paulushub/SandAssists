...
namespace ICSharpCode.SharpDevelop.Internal.Templates
{
	...
	/// </summary>
	public static class CodeTemplateLoader
	{
		static string TemplateFileName = "SharpDevelop-templates.xml";
		static string TemplateVersion  = "2.0";
		
		static List<CodeTemplateGroup> templateGroups = new List<CodeTemplateGroup>();
		...
		static bool LoadTemplatesFromStream(string filename)
		{
			...
			try {
				...
				templateGroups = new List<CodeTemplateGroup>();
