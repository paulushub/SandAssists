...
namespace ICSharpCode.SharpDevelop.Internal.Templates
{
	...
	/// categories.
	/// </summary>
    public sealed class TemplateCategorySortOrderFile
	{
		...
		public TemplateCategorySortOrderFile(string fileName) 
		{
            ...
            foreach (XmlElement category in doc.DocumentElement.SelectNodes("Category"))
            {
                ...
                foreach (XmlElement subCategory in category.SelectNodes("Category"))
                {
                    ...
                    {
                        sortOrders.Add(String.Concat(name, ",",
                            StringParser.Parse(subCategory.GetAttribute("Name"))),
                            GetSortOrder(subCategory.GetAttribute("SortOrder")));
                    }
                }
            }
		}
