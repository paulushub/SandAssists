...
{
	/// <summary>
	/// This class represents a single Code Template
	/// </summary>
	public sealed class CodeTemplate
	{
        ...
        public CodeTemplate(XmlElement el)
        {
            ...
            {
                throw new Exception(
                    "CodeTemplate(XmlElement el) : template and description attributes must exist (check the CodeTemplate XML)");
            }
		...
		public string Shortcut {
			...
			set {
				...
				Debug.Assert(shortcut != null, 
                    "ICSharpCode.SharpDevelop.Internal.Template : string Shortcut == null");
			}
		}
		...
		public string Description {
			...
			set {
				...
				Debug.Assert(description != null, 
                    "ICSharpCode.SharpDevelop.Internal.Template : string Description == null");
			}
		}
		...
		public string Text {
			...
			set {
				...
				Debug.Assert(text != null, 
                    "ICSharpCode.SharpDevelop.Internal.Template : string Text == null");
			}
		}
