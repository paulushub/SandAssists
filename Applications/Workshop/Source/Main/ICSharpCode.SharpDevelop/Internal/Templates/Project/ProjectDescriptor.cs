...
namespace ICSharpCode.SharpDevelop.Internal.Templates
{
	...
	public sealed class ProjectDescriptor
	{
		private sealed class ProjectProperty
		{
			...
			public ProjectProperty(string name, string value, string configuration, 
                string platform, PropertyStorageLocations location)
			{
				this.Name = name;
				this.Value = value;
		...
		{
			bool escapeIncludeValue = String.Equals(projectItemsElement.GetAttribute("escapeValue"), 
					...
					try {
						...
						if (file.ContentData != null) {
							...
							if (CodeEditorProperties.Instance.IndentationString != "\t") {
								fileContent = fileContent.Replace("\t", CodeEditorProperties.Instance.IndentationString);
							}
		...
		private void RunCreateActions(IProject project)
		{
