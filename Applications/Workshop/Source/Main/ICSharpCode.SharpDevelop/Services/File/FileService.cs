...
namespace ICSharpCode.SharpDevelop
{
	public static class FileService
	{
		...
		#region OpenedFile
		static Dictionary<string, OpenedFile> openedFileDict = 
            new Dictionary<string, OpenedFile>(StringComparer.OrdinalIgnoreCase);
		...
		{
			return NewFile(defaultName, 
                ParserService.DefaultFileEncoding.GetBytesWithPreamble(content));
		}
