...
namespace ICSharpCode.SharpDevelop
{
	...
	/// </summary>
	public class NavigationPoint : INavigationPoint
	{
		string fileName;
		object data;
		
		#region constructor
		public NavigationPoint() : this(String.Empty, null) {}
		public NavigationPoint(string fileName) : this(fileName, null) {}
		public NavigationPoint(string fileName, object data)
		{
...
//		}
		...
		{
			NavigationPoint b = obj as NavigationPoint;
		...
		public static bool operator == (NavigationPoint p1, NavigationPoint p2)
		{
