...
namespace ICSharpCode.SharpDevelop.Debugging
{
    public class CurrentLineBookmark : MarkerBookmark
	{
		...
		public static void SetPosition(string fileName, ITextDocument document, int makerStartLine, int makerStartColumn, int makerEndLine, int makerEndColumn)
		{
			Remove();
		...
		public CurrentLineBookmark(string fileName, ITextDocument document, TextLocation location) : base(fileName, document, location)
		{
			this.IsSaved = false;
