...
namespace ICSharpCode.SharpDevelop.Refactoring
{
	public static class NamespaceRefactoringService
	{
		...
		public static void ManageUsings(IProgressMonitor progressMonitor, string fileName, ITextDocument document, bool sort, bool removedUnused)
		{
			...
			if (removedUnused) {
				IList<IUsing> decl = cu.ProjectContent.Language.RefactoringProvider.FindUnusedUsingDeclarations(DomProgressMonitor.Wrap(progressMonitor), fileName, document.TextContent, cu);
			...
			cu.ProjectContent.Language.CodeGenerator.ReplaceUsings(new RefactorDocument(document), cu.UsingScope.Usings, newUsings);
		}
		...
		public static void AddUsingDeclaration(ICompilationUnit cu, ITextDocument document, string newNamespace, bool sortExistingUsings)
		{
