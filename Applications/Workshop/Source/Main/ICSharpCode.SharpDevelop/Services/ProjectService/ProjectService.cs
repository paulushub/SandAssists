...
namespace ICSharpCode.SharpDevelop.Project
{
	public static class ProjectService
	{
		...
		public static void LoadSolution(string fileName)
		{
            ...
            // Prevent the reopening of the same solution...
            if (openSolution != null && !openSolution.IsDisposed)
            {
                if (String.Equals(fileName, openSolution.FileName,
		...
		public static string GetAllProjectsFilter(object caller)
		{
			...
			foreach (string entry in addinTreeNode.BuildChildItems<string>(caller)) {
				b.Append('|');
				b.Append(entry);
			}
			return b.ToString();
