...
namespace ICSharpCode.SharpDevelop.Util
{
    ...
    /// </para>
	/// <para>
	/// This class does not create a worker thread on its own, it merely manages 
    /// tasks for the worker thread that calls <see cref="RunLoop"/>.
    /// </para>
	/// </summary>
	public sealed class WorkerThread
	{
		private sealed class AsyncTask : IAsyncResult
		{
