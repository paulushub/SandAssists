...
{
    public sealed class CreateNewSolution : AbstractMenuCommand
	{
    ...
    public sealed class LoadSolution : AbstractMenuCommand
	{
		public override void Run()
		{
    ...
    public sealed class CloseSolution : AbstractMenuCommand
	{
		public override void Run()
		{
