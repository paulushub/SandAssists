...
{
    public sealed class ViewProjectOptions : AbstractMenuCommand
	{
    ...
    public sealed class GenerateProjectDocumentation : AbstractMenuCommand
	{
		public override void Run()
		{
	...
	/// </summary>
    public sealed class OpenProjectFolder : AbstractMenuCommand
	{
		public override void Run()
		{
	...
	/// Opens the projects output folder in an explorer window.
	/// </summary>
    public sealed class OpenProjectOutputFolder : AbstractMenuCommand
	{
		public override void Run()
		{
			CompilableProject project = ProjectService.CurrentProject as CompilableProject;
