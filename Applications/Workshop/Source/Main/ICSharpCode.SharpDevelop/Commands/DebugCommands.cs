...
namespace ICSharpCode.SharpDevelop.Project.Commands
{
    ...
    public sealed class ExecuteWithoutDebugger : Execute
	{
		public override void Run()
		{
			withDebugger = false;
    ...
    public sealed class ContinueDebuggingCommand : AbstractMenuCommand
	{
		public override void Run()
		{
    ...
    public sealed class BreakDebuggingCommand : AbstractMenuCommand
	{
		public override void Run()
		{
    ...
    public sealed class StopDebuggingCommand : AbstractMenuCommand
	{
		public override void Run()
		{
    ...
    public sealed class StepDebuggingCommand : AbstractMenuCommand
	{
		public override void Run()
		{
    ...
    public sealed class StepIntoDebuggingCommand : AbstractMenuCommand
	{
		public override void Run()
		{
    ...
    public sealed class StepOutDebuggingCommand : AbstractMenuCommand
	{
		public override void Run()
		{
    ...
    public sealed class ToggleBreakpointCommand : AbstractMenuCommand
	{
		public override void Run()
		{
    ...
    public sealed class AttachToProcessCommand : AbstractMenuCommand
	{
		public override void Run()
		{
    ...
    public sealed class DetachFromProcessCommand : AbstractMenuCommand
	{
		public override void Run()
		{
