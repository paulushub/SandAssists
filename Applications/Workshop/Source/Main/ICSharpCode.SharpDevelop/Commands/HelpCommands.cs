...
{
    public sealed class ShowSensitiveHelp : AbstractMenuCommand
	{
    ...
    public sealed class LinkCommand : AbstractMenuCommand
	{
		string site;
    ...
    public sealed class HelpTopics : AbstractCommand
	{
		public override void Run()
		{
