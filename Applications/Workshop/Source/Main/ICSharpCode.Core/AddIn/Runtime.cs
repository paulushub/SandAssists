...
namespace ICSharpCode.Core
{
    public sealed class Runtime
	{
        ...
        private IList<LazyLoadDoozer> definedDoozers;
        private IList<LazyConditionEvaluator> definedConditionEvaluators;
        private ICondition[] conditions;

        public Runtime(string assembly, string hintPath)
        {
            isActive = true;
            definedDoozers = new List<LazyLoadDoozer>();
            definedConditionEvaluators = new List<LazyConditionEvaluator>();
