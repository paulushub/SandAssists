...
{
    /// <summary>
    /// Description of HtmlPreviewViewContent.
    /// </summary>
    public sealed class HtmlPreviewViewContent : AbstractSecondaryViewContent
    {
        ...
        public HtmlPreviewViewContent(IViewContent viewContent)
            : base(viewContent)
        {
            _fileName = viewContent.PrimaryFileName + ".html";
