...
{
    public sealed class TextAreaDragDropHandler
	{
		...
		private void InsertString(int offset, string str)
		{
			...
			textArea.SelectionManager.SetSelection(new TextSelection(textArea.Document,
		...
		private void OnDragDrop(object sender, DragEventArgs e)
		{
			...
			if (e.Data.GetDataPresent(typeof(string))) {
				...
				try {
					...
					if (e.Data.GetDataPresent(typeof(TextSelection))) {
						ISelection sel = (ISelection)e.Data.GetData(typeof(TextSelection));
