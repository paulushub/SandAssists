...
{
    public sealed class TextAreaClipboardHandler
	{
		TextArea textArea;
		...
		/// </remarks>
		public static ClipboardContainsTextDelegate ClipboardContainsText;
		
		public bool EnablePaste {
			get {
				if (!textArea.EnableCutOrPaste)
					return false;
				ClipboardContainsTextDelegate d = ClipboardContainsText;
				if (d != null) {
					return d();
				} else {
					try {
...
//			((DefaultWorkbench)WorkbenchSingleton.Workbench).UpdateToolbars();
		...
		private void OnCopyText(CopyTextEventArgs e)
		{
			if (CopyText != null) {
				CopyText(this, e);
			}
    ...
    public sealed class CopyTextEventArgs : EventArgs
	{
		string text;
