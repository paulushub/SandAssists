...
namespace ICSharpCode.TextEditor.Document
{
	public class LineCountChangeEventArgs : EventArgs
	{
		...
		public LineCountChangeEventArgs(ITextDocument document, int lineStart, int linesMoved)
		{
	...
	public class LineEventArgs : EventArgs
	{
		...
		public LineEventArgs(ITextDocument document, LineSegment lineSegment)
		{
			this.document = document;
	...
	public class LineLengthChangeEventArgs : LineEventArgs
	{
		...
		public LineLengthChangeEventArgs(ITextDocument document, LineSegment lineSegment, int moved)
