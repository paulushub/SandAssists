...
namespace ICSharpCode.TextEditor.Document
{
    ...
    public sealed class SelectionManager : IDisposable
	{
		...
		internal static bool SelectionIsReadOnly(ITextDocument document, ISelection sel)
		{
...
//				}
		...
		/// </summary>
		public SelectionManager(ITextDocument document)
		{
		...
		/// Creates a new instance of <see cref="SelectionManager"/>
		/// </summary>
		public SelectionManager(ITextDocument document, TextArea textArea)
		{
			this.document = document;
...
//			autoClearSelection = false;
		...
		{
			SetSelection(new TextSelection(document, startPosition, endPosition));
		}
		...
		public void ExtendSelection(TextLocation oldPosition, TextLocation newPosition)
		{
			...
			{
				SetSelection(new TextSelection(document, min, max));
