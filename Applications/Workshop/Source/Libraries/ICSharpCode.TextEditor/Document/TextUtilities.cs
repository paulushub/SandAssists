...
//						break;
		...
		public static int GetFirstNonWSChar(ITextDocument document, int offset)
		{
		...
		public static int FindWordEnd(ITextDocument document, int offset)
		{
		...
		public static int FindWordStart(ITextDocument document, int offset)
		{
			LineSegment line = document.GetLineSegmentForOffset(offset);
		...
		// next word
		public static int FindNextWordStart(ITextDocument document, int offset)
		{
		...
		public static int FindPrevWordStart(ITextDocument document, int offset)
		{
			int originalOffset = offset;
			if (offset > 0) {
				LineSegment line = document.GetLineSegmentForOffset(offset);
		...
		public static string GetLineAsString(ITextDocument document, int lineNumber)
		{
			LineSegment line = document.GetLineSegment(lineNumber);
			return document.GetText(line.Offset, line.Length);
		}
		
		public static int SearchBracketBackward(ITextDocument document, int offset, 
            char openBracket, char closingBracket)
		{
			return document.FormattingStrategy.SearchBracketBackward(document, 
                offset, openBracket, closingBracket);
		}
		
		public static int SearchBracketForward(ITextDocument document, int offset, 
            char openBracket, char closingBracket)
		{
			return document.FormattingStrategy.SearchBracketForward(document, 
                offset, openBracket, closingBracket);
		}
		...
		/// </remarks>
		public static bool IsEmptyLine(ITextDocument document, int lineNumber)
		{
		...
		/// Returns true, if the line lineNumber is empty or filled with whitespaces.
		/// </remarks>
		public static bool IsEmptyLine(ITextDocument document, LineSegment line)
		{
		...
		public static string GetWordAt(ITextDocument document, int offset)
		{
