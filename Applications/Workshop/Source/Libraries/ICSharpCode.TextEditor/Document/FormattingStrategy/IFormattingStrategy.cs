...
namespace ICSharpCode.TextEditor.Document
{
	...
	public interface IFormattingStrategy
	{
		...
		int SearchBracketBackward(ITextDocument document, int offset, char openBracket, char closingBracket);
		...
		int SearchBracketForward(ITextDocument document, int offset, char openBracket, char closingBracket);
	}
}
