...
namespace ICSharpCode.TextEditor.Document
{
	...
	public class DefaultFormattingStrategy : IFormattingStrategy
	{
		...
		/// </summary>
		public static void SmartReplaceLine(ITextDocument document, LineSegment line, string newLineText)
		{
			if (document == null)
		...
		public virtual int SearchBracketBackward(ITextDocument document, int offset, char openBracket, char closingBracket)
		{
			int brackets = -1;
		...
		public virtual int SearchBracketForward(ITextDocument document, int offset, char openBracket, char closingBracket)
		{
			int brackets = 1;
