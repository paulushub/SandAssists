...
namespace ICSharpCode.TextEditor.Document
{
	...
	public interface ITextDocument
	{
		...
		/// <summary>
		/// </summary>
		event DocumentEventHandler DocumentChanging;
		...
		/// <summary>
		/// The <see cref="IFormattingStrategy"/> attached to the <see cref="ITextDocument"/> instance
		/// </summary>
		...
		/// <summary>
		/// The <see cref="ITextBufferStrategy"/> attached to the <see cref="ITextDocument"/> instance
		/// </summary>
		...
		/// <summary>
		/// The <see cref="FoldingManager"/> attached to the <see cref="ITextDocument"/> instance
		/// </summary>
		...
		/// <summary>
		/// The <see cref="IHighlightingStrategy"/> attached to the <see cref="ITextDocument"/> instance
		/// </summary>
		...
		/// <summary>
		/// The <see cref="IBookMarkManager"/> attached to the <see cref="ITextDocument"/> instance
		/// </summary>
...
//		/// <summary>
//		/// The <see cref="SelectionManager"/> attached to the <see cref="ITextDocument"/> instance
//		/// </summary>
...
//		int GetVisibleColumn(int logicalLine, int logicalColumn);
		...
		string GetText(ITextSegment segment);
		...
		/// </value>
		IList<TextAreaUpdate> UpdateQueue {
			get;
		}
		...
		/// </summary>
		void UpdateSegmentListOnDocumentChange<T>(IList<T> list, DocumentEventArgs e) 
            where T : ITextSegment;
	}
}
