...
namespace ICSharpCode.TextEditor.Document
{
	...
	public class DocumentEventArgs : EventArgs
	{
		...
		/// </summary>
		public DocumentEventArgs(ITextDocument document) : this(document, -1, -1, null)
		{
		}
		...
		/// Creates a new instance off <see cref="DocumentEventArgs"/>
		/// </summary>
		public DocumentEventArgs(ITextDocument document, int offset) : this(document, offset, -1, null)
		{
		}
		...
		/// Creates a new instance off <see cref="DocumentEventArgs"/>
		/// </summary>
		public DocumentEventArgs(ITextDocument document, int offset, int length) : this(document, offset, length, null)
		{
		}
		...
		/// Creates a new instance off <see cref="DocumentEventArgs"/>
		/// </summary>
		public DocumentEventArgs(ITextDocument document, int offset, int length, string text)
		{
