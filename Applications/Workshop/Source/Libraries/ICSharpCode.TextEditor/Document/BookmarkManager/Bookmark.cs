...
namespace ICSharpCode.TextEditor.Document
{
	...
	public class Bookmark
	{
        ...
        public Bookmark(ITextDocument document, TextLocation location)
            : this(document, location, true)
        {
        }

        public Bookmark(ITextDocument document, TextLocation location, bool isEnabled)
        {
        ...
        public virtual BookmarkType BookmarkType
        {
            get
            {
