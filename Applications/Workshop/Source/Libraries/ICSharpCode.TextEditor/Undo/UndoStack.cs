...
namespace ICSharpCode.TextEditor.Undo
{
    ...
    public sealed class UndoStack
	{
		...
		/// </summary>
		internal bool AcceptChanges;

        public UndoStack()
        {
            undostack = new Stack<IUndoableOperation>();
            redostack = new Stack<IUndoableOperation>();
            AcceptChanges = true;
        }
