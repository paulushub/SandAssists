...
namespace ICSharpCode.TextEditor.Actions
{
	public abstract class AbstractLineFormatAction : AbstractEditAction
	{
		...
		abstract protected void Convert(ITextDocument document, int startLine, int endLine);
	...
	{
		protected TextArea textArea;
		abstract protected void Convert(ITextDocument document, int offset, int length);
    ...
    public sealed class RemoveLeadingWS : AbstractLineFormatAction
	{
		protected override void Convert(ITextDocument document, int y1, int y2)
		{
			for (int i = y1; i < y2; ++i) {
    ...
    public sealed class RemoveTrailingWS : AbstractLineFormatAction
	{
		protected override void Convert(ITextDocument document, int y1, int y2)
		{
    ...
    public sealed class ToUpperCase : AbstractSelectionFormatAction
	{
		protected override void Convert(ITextDocument document, int startOffset, int length)
		{
    ...
    public sealed class ToLowerCase : AbstractSelectionFormatAction
	{
		protected override void Convert(ITextDocument document, int startOffset, int length)
		{
    ...
    public sealed class InvertCaseAction : AbstractSelectionFormatAction
	{
		protected override void Convert(ITextDocument document, int startOffset, int length)
		{
    ...
    public sealed class CapitalizeAction : AbstractSelectionFormatAction
	{
		protected override void Convert(ITextDocument document, int startOffset, int length)
		{
			StringBuilder what = new StringBuilder(document.GetText(startOffset, length));
    ...
    public sealed class ConvertTabsToSpaces : AbstractSelectionFormatAction
	{
		protected override void Convert(ITextDocument document, int startOffset, int length)
		{
    ...
    public sealed class ConvertSpacesToTabs : AbstractSelectionFormatAction
	{
		protected override void Convert(ITextDocument document, int startOffset, int length)
		{
			string what = document.GetText(startOffset, length);
    ...
    public sealed class ConvertLeadingTabsToSpaces : AbstractLineFormatAction
	{
		protected override void Convert(ITextDocument document, int y1, int y2)
		{
			for (int i = y2; i >= y1; --i) {
    ...
    public sealed class ConvertLeadingSpacesToTabs : AbstractLineFormatAction
	{
		protected override void Convert(ITextDocument document, int y1, int y2)
		{
			for (int i = y2; i >= y1; --i) {
	...
	/// </summary>
    public sealed class FormatSelection : AbstractLineFormatAction
	{
		protected override void Convert(ITextDocument document, int startLine, int endLine)
		{
