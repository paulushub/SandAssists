...
{
	public sealed class ToggleBookmark : AbstractEditAction
	{
    ...
    public sealed class GotoPrevBookmark : AbstractEditAction
	{
    ...
    public sealed class GotoNextBookmark : AbstractEditAction
	{
		Predicate<Bookmark> predicate = null;
    ...
    public sealed class ClearAllBookmarks : AbstractEditAction
	{
		Predicate<Bookmark> predicate = null;
