...
namespace ICSharpCode.TextEditor.Actions
{
	...
	{
		public static string GetIndentationString(ITextDocument document)
		{
			return GetIndentationString(document, null);
		}
		
		public static string GetIndentationString(ITextDocument document, TextArea textArea)
		{
		...
		void InsertTabs(ITextDocument document, ISelection selection, int y1, int y2)
		{
...
//				document.Replace(line.Offset,line.Length,newLine);
	...
	{
		void RemoveTabs(ITextDocument document, ISelection selection, int y1, int y2)
		{
...
//					string temp = document.GetText(line.Offset,line.Length);
    ...
    public sealed class ToggleComment : AbstractEditAction
	{
		/// <remarks>
		/// Executes this edit action
		/// </remarks>
    ...
    public sealed class ToggleLineComment : AbstractEditAction
	{
		int firstLine;
		int lastLine;
		
		void RemoveCommentAt(ITextDocument document, string comment, ISelection selection, int y1, int y2)
		{
			firstLine = y1;
			lastLine  = y2;
		...
		void SetCommentAt(ITextDocument document, string comment, ISelection selection, int y1, int y2)
		{
			firstLine = y1;
			lastLine  = y2;
		...
		bool ShouldComment(ITextDocument document, string comment, ISelection selection, int startLine, int endLine)
		{
    ...
    public sealed class ToggleBlockComment : AbstractEditAction
	{
		/// <remarks>
		/// Executes this edit action
		/// </remarks>
		...
		public static BlockCommentRegion FindSelectedCommentRegion(ITextDocument document, string commentStart, string commentEnd, int selectionStartOffset, int selectionEndOffset)
		{
		...
		void SetCommentAt(ITextDocument document, int offsetStart, int offsetEnd, string commentStart, string commentEnd)
		{
			document.Insert(offsetEnd, commentEnd);
			document.Insert(offsetStart, commentStart);
		}
		
		void RemoveComment(ITextDocument document, BlockCommentRegion commentRegion)
		{
    ...
    public sealed class Backspace : AbstractEditAction
	{
		/// <remarks>
		/// Executes this edit action
		/// </remarks>
...
//						textArea.Document.RequestUpdate(new TextAreaUpdate(TextAreaUpdateType.PositionToLineEnd, new TextLocation(textArea.Caret.Offset - textArea.Document.GetLineSegment(curLineNr).Offset, curLineNr)));
    ...
    public sealed class Return : AbstractEditAction
	{
		/// <remarks>
		/// Executes this edit action
		/// </remarks>
    ...
    public sealed class ToggleEditMode : AbstractEditAction
	{
		/// <remarks>
		/// Executes this edit action
		/// </remarks>
    ...
    public sealed class Undo : AbstractEditAction
	{
		/// <remarks>
		/// Executes this edit action
		/// </remarks>
    ...
    public sealed class Redo : AbstractEditAction
	{
		/// <remarks>
		/// Executes this edit action
		/// </remarks>
	...
	/// take you to
	/// </summary>
    public sealed class WordBackspace : AbstractEditAction
	{
		/// <remarks>
		/// Executes this edit action
		/// </remarks>
	...
	/// </summary>
    public sealed class DeleteWord : Delete
	{
		/// <remarks>
		/// Executes this edit action
		/// </remarks>
