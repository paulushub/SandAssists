...
namespace ICSharpCode.NRefactory.Visitors
{
	...
	public class VBNetConstructsConvertVisitor : ConvertVisitorBase
	{
			...
			if (body != null && body.Children.Count > 0) {
				...
				if (se != null) {
					...
					if (ie != null) {
						...
						if (fre != null && String.Equals("New", fre.MemberName, StringComparison.OrdinalIgnoreCase)) {
		...
		public override object VisitMethodDeclaration(MethodDeclaration methodDeclaration, object data)
		{
			...
			if (String.Equals("Finalize", methodDeclaration.Name, StringComparison.OrdinalIgnoreCase)
				    ...
				    && tcs.FinallyBlock.Children.Count == 1)
				{
					...
					if (se != null) {
						...
						if (ie != null
						    ...
						    && String.Equals("Finalize", (ie.TargetObject as MemberReferenceExpression).MemberName, StringComparison.OrdinalIgnoreCase))
						{
			    ...
			    && methodDeclaration.Body.Children.Count == 0)
			{
				foreach (AttributeSection sec in methodDeclaration.Attributes) {
					foreach (Attribute att in sec.Attributes) {
						if (String.Equals("DllImport", att.Name, StringComparison.OrdinalIgnoreCase)) {
		...
		static bool IsAssignmentTo(INode statement, string varName)
		{
			...
			return ident.Identifier.Equals(varName, StringComparison.OrdinalIgnoreCase);
		}
		...
		class ReturnStatementForFunctionAssignment : AbstractAstTransformer
		{
			...
			{
				if (identifierExpression.Identifier.Equals(functionName, StringComparison.OrdinalIgnoreCase)) {
		...
		public override object VisitInvocationExpression(InvocationExpression invocationExpression, object data)
		{
			...
			if (ident != null) {
				if (String.Equals("IIF", ident.Identifier, StringComparison.OrdinalIgnoreCase)
				...
				if (String.Equals("IsNothing", ident.Identifier, StringComparison.OrdinalIgnoreCase)
