...
namespace ICSharpCode.NRefactory.Parser.VB
{
	internal sealed partial class Parser : AbstractParser
	{
		...
		bool IsGlobalAttrTarget () {
			Token pt = Peek(1);
			return la.kind == Tokens.LessThan && ( string.Equals(pt.val, "assembly", StringComparison.OrdinalIgnoreCase) || string.Equals(pt.val, "module", StringComparison.OrdinalIgnoreCase));
		}
