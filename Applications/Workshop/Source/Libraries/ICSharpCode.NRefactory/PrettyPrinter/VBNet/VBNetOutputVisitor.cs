...
namespace ICSharpCode.NRefactory.PrettyPrinter
{
	public sealed class VBNetOutputVisitor : NodeTrackingAstVisitor, IOutputAstVisitor
	{
		...
		public override object TrackedVisitAttributeSection(AttributeSection attributeSection, object data)
		{
			...
			if (String.Equals("assembly", attributeSection.AttributeTarget, StringComparison.OrdinalIgnoreCase)
			    || String.Equals("module", attributeSection.AttributeTarget, StringComparison.OrdinalIgnoreCase)) {
