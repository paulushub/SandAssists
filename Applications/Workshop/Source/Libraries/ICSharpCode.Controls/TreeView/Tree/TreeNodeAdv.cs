...
namespace Aga.Controls.Tree
{
	...
	public class TreeNodeAdv : ISerializable
	{
		...
		protected internal virtual void OnCollapsing()
		{
			if (Collapsing != null)
        ...
        protected internal virtual void OnCollapsed()
		{
			if (Collapsed != null)
        ...
        protected internal virtual void OnExpanding()
		{
			if (Expanding != null)
        ...
        protected internal virtual void OnExpanded()
		{
			if (Expanded != null)
		...
		public TreeNodeAdv(TreeViewAdv tree, object tag)
		{
			...
			_children = new Collection<TreeNodeAdv>(_nodes);
			_tag = tag;
		}
