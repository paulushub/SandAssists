...
namespace ICSharpCode.Controls
{
	/// <summary>
	...
	public static class TextEllipsis
	{
		...
		public static string Compact(string text, Control ctrl, EllipsisFormat options)
		{
			...
			{
                compactText = Compact(text, dc, ctrl.Font, options, ctrl.Width);
			}

            return compactText;
		}

        public static string Compact(string text, Graphics graphics, Font font,
            EllipsisFormat options, int width)
        {
            ...
            while (seg > 1)
            {
                ...
                s = TextRenderer.MeasureText(graphics, tst, font);
            ...
            if (len == 0) // string can't fit into control
            {
                ...
                s = TextRenderer.MeasureText(graphics, fit, font);
