...
namespace Sandcastle.Viewers.HtmlHelp
{
	...
	/// </summary>
	public sealed class HtmlHelpIndexTopic
	{
		...
		internal static HtmlHelpIndexTopic FromTopicEntry(TopicEntry entry)
		{
			return new HtmlHelpIndexTopic(entry.EntryOffset, entry.ChmFile);
		...
		internal HtmlHelpIndexTopic(int topicOffset, CHMFile associatedFile)
		{
		...
		public HtmlHelpIndexTopic(string Title, string local, string compilefile, string chmpath)
		{
		...
		/// </summary>
		/// <remarks>If the file can't be opened the property will return an empty string (same for binary data)</remarks>
