...
namespace Sandcastle.Viewers.HtmlHelp
{
	...
	public class Category
	{
		...
		private List<InformationType> _infoTypes = null;
		...
		public Category(string name, string description) :
            this(name, description, new List<InformationType>())
		{
		}
		/// <summary>
		/// Standard constructor
		...
		public Category(string name, string description,
            List<InformationType> linkedInformationTypes)
		{
			_name = name;
		...
		/// <summary>
		/// Gets an list with the linked Information types
		/// </summary>
