...
namespace Sandcastle.Viewers.HtmlHelp.Storage
{
    ...
    internal class IBaseStorageWrapper
    {
		...
		/// </summary>
        public IList<FileObject> foCollection;
        ...
        {
            foCollection = new List<FileObject>();
        }
        ...
        protected void EnumIStorageObject(Interop.IStorage enumStorage, string BasePath)
        {
            ...
            while (iEnumSTATSTG.Next(1, out sTATSTG, out i) == (int)Interop.S_OK)
            {
                ...
                case 2:
                    IStream uCOMIStream = enumStorage.OpenStream(sTATSTG.pwcsName, IntPtr.Zero, 16, 0);
                    newFileObj.FilePath = BasePath;
                    newFileObj.FileName = sTATSTG.pwcsName.ToString();
