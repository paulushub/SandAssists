...
namespace Sandcastle.Viewers.HtmlHelp.Decoding
{
	...
	internal sealed class HHCParser
	{
		...
		/// </summary>
        private static List<HtmlHelpTocItem> _mergeItems = null;
		...
		/// </summary>
		private static HtmlHelpTocItem _lastTopicItem = null;
		...
		/// <summary>
		/// Gets all HtmlHelpTocItem references which are holding merge-links
		/// </summary>
        public static List<HtmlHelpTocItem> MergeItems
		{
