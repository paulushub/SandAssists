...
namespace Sandcastle.Viewers.HtmlHelp.Controls
{
	...
	{
        private IList<HtmlHelpIndexTopic> _items = null;
		private string _url = "";
		...
		private void TopicsFound_Load(object sender, System.EventArgs e)
		{
			if(_items != null)
			{
				foreach(HtmlHelpIndexTopic curEntry in _items)
				{
		...
		private void lvTopics_DoubleClick(object sender, System.EventArgs e)
		{
			...
			{
				_url = ((HtmlHelpIndexTopic)(lvTopics.SelectedItems[0].Tag)).URL;
				_title = ((HtmlHelpIndexTopic)(lvTopics.SelectedItems[0].Tag)).Title;
		...
		/// </summary>
        public IList<HtmlHelpIndexTopic> Items
		{
			get { return _items; }
			set { _items = value; }
		}
