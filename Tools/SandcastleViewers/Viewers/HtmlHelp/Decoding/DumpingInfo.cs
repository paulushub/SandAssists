...
namespace Sandcastle.Viewers.HtmlHelp.Decoding
{
	...
	public sealed class DumpingInfo
	{
        ...
        private DeflateStream _outputStream = null;
        private DeflateStream _inputStream = null;
...
//						_outputStream = new DeflaterOutputStream(stream.BaseStream, new Deflater(CompLvl));
                        _outputStream = new DeflateStream(stream.BaseStream, CompressionMode.Compress);
			...
			get
			{
				...
				if(_reader==null)
				{
					...
					else 
					{
                        ...
                        _inputStream = new DeflateStream(stream.BaseStream, CompressionMode.Decompress);
