...
{
    [Serializable]
    public class ConceptualMetadataContent : BuildContent<ConceptualMetadataItem, ConceptualMetadataContent>
    {
        ...
        {   
            ...
            try
            {
                string settingPath = Path.Combine(tocDir, ConceptualUtils.MetadataFile);
        ...
        private void CreateMetadata()
        {
            ...
            _runningHeaderText = "topicRunningHeaderText"; // "b1b997af-3127-4001-b77b-5263e4496939"
