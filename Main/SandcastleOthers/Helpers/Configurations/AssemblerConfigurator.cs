...
{
    /// <summary>
    /// This is an <see cref="abstract"/> base class for configuration handlers used in
    ...
    public abstract class AssemblerConfigurator : BuildConfigurator
    {
        ...
        protected AssemblerConfigurator()
        {
            ...
            string sandcastlePath = Environment.ExpandEnvironmentVariables(
                "%DXROOT%");
        ...
        /// </value>
        protected abstract BuildEngine Engine
        {
            get;
        }
        ...
        public virtual void Initialize(BuildEngine engine)
        {
            ...
            string fullPath = Environment.ExpandEnvironmentVariables(
                sandcastlePath);
            ...
            if (engineType == BuildEngineType.Reference &&
                (_dicConfigMap.ContainsKey("SandcastleCopyComponent") == false))
            {
                if (String.IsNullOrEmpty(sandcastlePath) == false ||
                    Directory.Exists(sandcastlePath))
                {
                    ...
                    _dicConfigMap.Add("SandcastleCopyComponent", copyComponents);
                }
            }
        ...
        {
            if (_isInitialized == false || String.IsNullOrEmpty(_sourceFile) ||
