...
namespace Sandcastle.Steps
{
    ...
    public class StepChmBuilder : StepProcess
    {
        ...
        public StepChmBuilder(StepChmBuilder source)
            : base(source)
        {
            _helpName   = source._helpName;
            _helpFolder = source._helpFolder;
        }
        ...
        protected override bool MainExecute(BuildEngine engine)
        {
            ...
            try
            {
                buildResult = PreProcess(engine, logger);
                ...
                if (buildResult)
                {
                    buildResult = PostProcess(engine, logger);
                }
            }
            catch (Exception ex)
            {
        ...
        private bool PreProcess(BuildEngine engine, BuildLogger logger)
        {
            bool buildResult = false;
            ...
            configurator.Initialize(engine);
        ...
        private bool PostProcess(BuildEngine engine, BuildLogger logger)
        {
            bool buildResult = false;
        ...
        {
            StepChmBuilder buildStep = new StepChmBuilder(this);
            ...
            if (_helpName != null)
            {
                buildStep._helpName = String.Copy(_helpName);
            }
