...
namespace Sandcastle.Steps
{
    ...
    public class StepHxsViewerStart : BuildStep
    {
        ...
        public StepHxsViewerStart(StepHxsViewerStart source)
            : base(source)
        {
        }
        ...
        protected override bool MainExecute(BuildEngine engine)
        {
            ...
            try
            {
                string arguments = String.Format(" -n {0} -c {1} -d \"Sandcastle Documentations\"",
            ...
            try
            {
                CultureInfo culture = engine.Settings.CultureInfo;
                int lcid = 1033;
                if (culture != null)
                {
                    lcid = culture.LCID;
        ...
        {
            StepHxsViewerStart buildStep = new StepHxsViewerStart(this);
