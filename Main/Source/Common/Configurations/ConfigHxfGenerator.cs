...
{
    [Serializable]
    public class ConfigHxfGenerator : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigHxfGenerator()
        {
        }

        public ConfigHxfGenerator(ConfigHxfGenerator source)
            : base(source)
        {
        }
        ...
        {
            ConfigHxfGenerator configObject = new ConfigHxfGenerator(this);
