...
{
    [Serializable]
    public class ConfigResolveReferenceLinks : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigResolveReferenceLinks()
        {
        }

        public ConfigResolveReferenceLinks(ConfigResolveReferenceLinks source)
            : base(source)
        {
        }
        ...
        {
            ConfigResolveReferenceLinks configObject = new ConfigResolveReferenceLinks(this);
