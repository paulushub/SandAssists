...
{
    [Serializable]
    public class ConfigCopyFromIndex : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigCopyFromIndex()
        {
        }

        public ConfigCopyFromIndex(ConfigCopyFromIndex source)
            : base(source)
        {
        }
        ...
        {
            ConfigCopyFromIndex configObject = new ConfigCopyFromIndex(this);
