...
{
    [Serializable]
    public class ConfigSharedContent : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigSharedContent()
        {
        }

        public ConfigSharedContent(ConfigSharedContent source)
            : base(source)
        {
        }
        ...
        {
            ConfigSharedContent configObject = new ConfigSharedContent(this);
