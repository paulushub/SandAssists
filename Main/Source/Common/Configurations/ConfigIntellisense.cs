...
{
    [Serializable]
    public class ConfigIntellisense : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigIntellisense()
        {
        }

        public ConfigIntellisense(ConfigIntellisense source)
            : base(source)
        {
        }
        ...
        {
            ConfigIntellisense configObject = new ConfigIntellisense(this);
