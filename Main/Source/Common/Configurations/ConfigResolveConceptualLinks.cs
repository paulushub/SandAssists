...
{
    [Serializable]
    public class ConfigResolveConceptualLinks : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigResolveConceptualLinks()
        {
        }

        public ConfigResolveConceptualLinks(ConfigResolveConceptualLinks source)
            : base(source)
        {
        }
        ...
        {
            ConfigResolveConceptualLinks configObject = new ConfigResolveConceptualLinks(this);
