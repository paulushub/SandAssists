...
namespace Sandcastle.Construction.Utils
{
	...
	/// 1) Parse the entire stream at once and get an <see cref="System.Collections.Generic.IList"/> 
	...
	/// </para>
	/// </remarks>
    public sealed class StreamTokenizer
	{
		...
		/// <summary>
		/// Tokenize a file completely and return the tokens in a list.
		/// </summary>
		/// <param name="fileName">The file to tokenize.</param>
		/// <returns>A list with all tokens.</returns>
        public IList<Token> TokenizeFile(string fileName)
		{
