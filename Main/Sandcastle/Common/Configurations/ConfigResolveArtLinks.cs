...
{
    [Serializable]
    public class ConfigResolveArtLinks : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigResolveArtLinks()
        {
        }

        public ConfigResolveArtLinks(ConfigResolveArtLinks source)
            : base(source)
        {
        }
        ...
        {
            ConfigResolveArtLinks configObject = new ConfigResolveArtLinks(this);
