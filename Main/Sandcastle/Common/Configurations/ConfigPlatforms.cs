...
{
    [Serializable]
    public class ConfigPlatforms : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigPlatforms()
        {
        }

        public ConfigPlatforms(ConfigPlatforms source)
            : base(source)
        {
        }
        ...
        {
            ConfigPlatforms configObject = new ConfigPlatforms(this);
