...
{
    [Serializable]
    public class ConfigCopyFromFile : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigCopyFromFile()
        {
        }

        public ConfigCopyFromFile(ConfigCopyFromFile source)
            : base(source)
        {
        }
        ...
        {
            ConfigCopyFromFile configObject = new ConfigCopyFromFile(this);
