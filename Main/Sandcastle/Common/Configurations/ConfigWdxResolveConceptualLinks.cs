...
{
    [Serializable]
    public class ConfigWdxResolveConceptualLinks : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigWdxResolveConceptualLinks()
        {
        }

        public ConfigWdxResolveConceptualLinks(ConfigWdxResolveConceptualLinks source)
            : base(source)
        {
        }
        ...
        {
            ConfigWdxResolveConceptualLinks configObject = new ConfigWdxResolveConceptualLinks(this);
