...
{
    [Serializable]
    public class ConfigPostTransform : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigPostTransform()
        {
        }

        public ConfigPostTransform(ConfigPostTransform source)
            : base(source)
        {
        }
        ...
        {
            ConfigPostTransform configObject = new ConfigPostTransform(this);
