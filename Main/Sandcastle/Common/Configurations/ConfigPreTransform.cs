...
{
    [Serializable]
    public class ConfigPreTransform : ConfigObject
    {
        #region Constructors and Destructor

        public ConfigPreTransform()
        {
        }

        public ConfigPreTransform(ConfigPreTransform source)
            : base(source)
        {
        }
        ...
        {
            ConfigPreTransform configObject = new ConfigPreTransform(this);
