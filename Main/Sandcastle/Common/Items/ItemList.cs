...
namespace Sandcastle.Items
{
    ...
    [Serializable]
    public class ItemList<T> : Collection<T>, ICloneable
         where T : class, ICloneable
    {
        ...
        public event EventHandler<ItemListEventArgs<T>> Changed;
        ...
        /// <summary>
        /// This inserts an element into the <see cref="ItemList{T}">collection</see> 
        ...
        protected override void InsertItem(int index, T newItem)
        {
            ...
            if (Changed != null)
            {
                Changed(this, new ItemListEventArgs<T>(
                    ItemListChangeType.Added, newItem, null, index));
            }
        }
        ...
        protected override void SetItem(int index, T newItem)
        {
            ...
            {
                Changed(this, new ItemListEventArgs<T>(
                    ItemListChangeType.Replaced, replaced, newItem, index));
            }
        }

        /// <summary>
        /// This removes the element at the specified index of the 
        /// <see cref="ItemList{T}">collection</see>.
        /// </summary>
        /// <param name="index">
        ...
        protected override void RemoveItem(int index)
        {
            ...
            {
                Changed(this, new ItemListEventArgs<T>(
                    ItemListChangeType.Removed, removedItem, null, index));
            }
        }

        /// <summary>
        /// This removes all elements from the <see cref="ItemList{T}">
        /// collection</see>. 
        /// </summary>
        protected override void ClearItems()
        {
            ...
            {
                Changed(this, new ItemListEventArgs<T>(
                    ItemListChangeType.Cleared, null, null, -1));
            }
        }
        ...
        /// </summary>
        /// <param name="e">
        /// The <see cref="ItemListEventArgs{T}"/> specifying the event
        /// information.
        /// </param>
        protected virtual void FireChanged(ItemListEventArgs<T> e)
        {
            if (Changed != null)
            {
                Changed(this, e);
        ...
        public ItemList<T> Clone()
        {
            ItemList<T> clonedList = new ItemList<T>();
