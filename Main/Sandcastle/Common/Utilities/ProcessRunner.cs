...
namespace Sandcastle.Utilities
{
    public class ProcessRunner : MarshalByRefObject, IDisposable
    {
        ...
        private HelpLogger      _processLogger;
        ...
        public virtual bool Start(ProcessInfo info, HelpLogger buildLogger)
        {
            if (info == null)
            {
            ...
            catch (Exception ex)
            {
                ...
                if (buildLogger != null)
                {
                    buildLogger.WriteLine(ex, HelpLoggerLevel.Error);
                }
        ...
        public virtual bool Stop()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    _processLogger.WriteLine(ex, HelpLoggerLevel.Error);
                }
            ...
            DataReceivedEventArgs e)
        {
            ...
            if (_processLogger != null)
            {
                _processLogger.WriteLine(dataReceived, HelpLoggerLevel.None);
            }
            ...
            DataReceivedEventArgs e)
        {
            ...
            if (_processLogger != null)
            {
                _processLogger.WriteLine(dataReceived, HelpLoggerLevel.Error);
            }
