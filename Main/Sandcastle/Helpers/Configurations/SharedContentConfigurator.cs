    ...
    public class SharedContentConfigurator : BuildConfigurator
    {
        ...
        public override bool HasContents
        {
            get
            {
                ...
                SharedContent content = _style.GetContent(BuildStyle.SharedDefault);
                ...
                {
                    content = _style.GetContent(BuildStyle.SharedReferences);
                    if (content != null && content.Count > 0)
                    {
                        return true;
                    }
                ...
                {
                    content = _style.GetContent(BuildStyle.SharedConceptual);
                    if (content != null && content.Count > 0)
                    {
                        return true;
                    }
            ...
            BuildEngineType engineType)
        {
            ...
            BuildStyleType styleType = _style.StyleType;
            ...
            _ruleContent.Add(new RuleItem("Feedback", fbType.ToString()));
        ...
        public virtual ConfigurationItem GetItem(string keyword)
        {
