...
{
	/// <summary>
	/// The class <c>HtmlHelpFileInfo</c> only extracts system information from a CHM file. 
	/// It doesn't build the index and table of contents.
	/// </summary>
	public class HtmlHelpFileInfo
	{
		/// <summary>
		...
		public HtmlHelpFileInfo(string chmFile)
		{
		...
		/// <summary>
		/// Internal constructor used in the class <see cref="Sandcastle.Viewers.HtmlHelp.Decoding.CHMFile">CHMFile</see>.
		/// </summary>
		/// <param name="associatedFile">associated chm file</param>
		internal HtmlHelpFileInfo(CHMFile associatedFile)
		{
