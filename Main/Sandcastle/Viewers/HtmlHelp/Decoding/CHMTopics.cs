...
namespace Sandcastle.Viewers.HtmlHelp.Decoding
{
	...
	public sealed class CHMTopics : IDisposable
	{
		...
		/// </summary>
        private List<TopicEntry> _topicTable = new List<TopicEntry>();
		...
		/// </summary>
        public List<TopicEntry> TopicTable
		{
			get
			{
				return _topicTable;
        ...
        public List<TopicEntry> GetByExtension(string fileExtension)
		{
            List<TopicEntry> arrRet = new List<TopicEntry>();
