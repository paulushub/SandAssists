...
namespace Sandcastle.Viewers.HtmlHelp
{
	...
	/// </summary>
	public class HtmlHelpIndex
	{
        private IList<HtmlHelpIndexItem> _kLinks = new List<HtmlHelpIndexItem>();
        private IList<HtmlHelpIndexItem> _aLinks = new List<HtmlHelpIndexItem>();

		/// <summary>
		/// Standard constructor
		/// </summary>
		public HtmlHelpIndex()
		{
		}
		...
		/// </summary>
		/// <param name="kLinks">array list with keyword links</param>
		/// <param name="aLinks">array list with associative links</param>
        public HtmlHelpIndex(IList<HtmlHelpIndexItem> kLinks, IList<HtmlHelpIndexItem> aLinks)
		{
			_kLinks= kLinks;
			_aLinks = aLinks;
		}
		...
		/// </summary>
        public IList<HtmlHelpIndexItem> KLinks
		{
			get 
			{
				if(_kLinks==null)
                    _kLinks = new List<HtmlHelpIndexItem>();
		...
		/// </summary>
		public IList<HtmlHelpIndexItem> ALinks
		{
			get 
			{
				if(_aLinks==null)
					_aLinks = new List<HtmlHelpIndexItem>();
		...
		private HtmlHelpIndexItem ContainsIndex(IList<HtmlHelpIndexItem> arrIndex, string keywordPath)
		{
			foreach(HtmlHelpIndexItem curItem in arrIndex)
			{
